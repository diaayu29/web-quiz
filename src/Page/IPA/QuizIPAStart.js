  ...
  return (
    <div className = "StartPage bg-purpleLight h-screen md:flex">
        ...
        <div className = "StartQuiz bg-pinkLight md:relative md:w-2/4">
          <Link to="/questionIPA"><button className = "bg-buttonLight absolute top-2/4 md:top-1/2 left-1/3 md:left-1/2 px-4 py-2 md:px-8 md:py-4 rounded-lg text-white" type = "button">Mulai</button></Link>
        </div>
      </div>
  )
}

export default ShowIPA;